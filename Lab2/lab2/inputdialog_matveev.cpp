...
InputDialog_Matveev::InputDialog_Matveev(QWidget* pwgt): QDialog(pwgt)
{
...
QString InputDialog_Matveev::firstName() const
{
    return m_ptxtFirstName->text();
}

QString InputDialog_Matveev::lastName() const
{
